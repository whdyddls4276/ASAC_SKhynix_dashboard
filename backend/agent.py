...
- "두 질문을 함께/순서대로 확인하겠습니다", "조회하겠습니다" 같은 서두·과정 안내 발언 금지. 곧바로 결론부터 답한다 (진행상황은 로딩 UI가 표시).
...
- **서두 멘트 금지**: "조회하겠습니다", "두 tool을 함께 조회하겠습니다", "순서대로 확인하겠습니다" 같은 과정 안내 문장을 앞에 붙이지 말고 곧바로 결과(결론)부터 말하세요. 진행 상황은 로딩 UI가 이미 보여줍니다.
